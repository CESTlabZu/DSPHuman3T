...
load('data\roi_brain');
% read T1 map
Imag1_T1=dicomread('data\T1_MAP\IM_0180');
% data
sub_num=1;

%0p5 and 1p0
ls=dir('data\CEST_05uT_36s_51points');
    mniDir = ['data\CEST_05uT_36s_51points\'];
for ij = 3:length(ls)
...
ls=dir('data\CEST_10uT_36s_51points');
    mniDir = ['data\CEST_10uT_36s_51points\'];
for ij = 3:length(ls)
Imag1_1p0uT(:,:,ij-2)=dicomread([mniDir, ls(ij).name]);
end
for ii=1:51
